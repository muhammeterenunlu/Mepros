class FurnitureLoadStrategy_tr extends LoadStrategy {
  loadProduct(product) {
    ...
    this.#createAndPushMaterials(productData.materials_tr);

    this.#setInstructions(productData.instructions_tr);
  }
