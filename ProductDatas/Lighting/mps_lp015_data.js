mps_lp015_data = {
  ...
  colorsImagesDictionary: {
    '#000000': ['../lighting-images/MPS-LP015.png'],
  },
  tags: [
    'Housing accommodates up to 4 LED lighting units (LED Board: 16 / 24 LED)',
  ...
  tags_tr: [
    'Gövde 4 LEDe kadar aydınlatma ünitesi barındırır (LED Panosu: 16 / 24 LED)',
...
globals.productManager.addProduct(new LightingProduct(mps_lp015_data));
