mps_lp054_data = {
  ...
  colorsImagesDictionary: {
    '#000000': ['../lighting-images/MPS-LP054.png'],
  },
  tags: [
    'Light building elements with symmetric light distribution',
    'A series of light building elements with symmetric light distribution. Light building elements are luminous design features for public areas. They are ideally suited for delineating and structuring interior and exterior spaces such as landscape areas, plazas, building entrances and atria.',
  ...
  tags_tr: [
    ...
    'Simetrik ışık dağılımına sahip bir dizi hafif yapı elemanı. Hafif yapı elemanları, ortak alanlar için aydınlık tasarım özellikleridir. Peyzaj alanları, plazalar, bina girişleri ve atriyumlar gibi iç ve dış mekanların tanımlanması ve yapılandırılması için idealdirler.',
    'Döküm ve ekstrüde alüminyum. Şeffaf güvenlik camı Saf anodize alüminyumdan yapılmış reflektör Galvanizli çelikten yapılmış ankraj ünitesi',
...
globals.productManager.addProduct(new LightingProduct(mps_lp054_data));
