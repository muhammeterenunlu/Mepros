mps_lp014_data = {
  ...
  colorsImagesDictionary: {
    '#8B5A23': ['../lighting-images/MPS-LP014.png'],
  },
  tags: [
    'Housing accommodates up to 6 LED lighting units (LED Board: 16 / 24 LED)',
...
globals.productManager.addProduct(new LightingProduct(mps_lp014_data));
