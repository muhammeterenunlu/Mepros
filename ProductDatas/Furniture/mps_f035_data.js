mps_f035_data = {
  ...
  colorsImagesDictionary: {
    '#143789': [
      '../furniture-images/MPS-F035v1.jpeg',
      '../furniture-images/MPS-F035v2.jpeg',
      '../furniture-images/MPS-F035v3.jpeg',
    ],
  },
  tags: [
  ...
  tags_tr: [
    ...
    'Sırt yastıkları dolgu malzemesine göre bölme sayısına sahiptir',
  ],
  materials: [
    'Plywood framework',
    ...
    'High resilient foam core and blown fibre filled back cushions (separated) (1/3)',
  ...
  technicalData: '../techdata/MPS-F035.pdf',
};

globals.productManager.addProduct(new FurnitureProduct(mps_f035_data));
