mps_f048_data = {
  ...
  colorsImagesDictionary: {
    '#e5e5e5': [
      '../furniture-images/MPS-F048v1.jpeg',
      '../furniture-images/MPS-F048v2.jpeg',
      '../furniture-images/MPS-F048v3.jpeg',
    ],
  },
  tags: [
  ...
  materials: [
    ...
    'High resilient foam core and blown fibre filled back cushions (separated) (1/5)',
  ...
  materials_tr: [
    ...
    'Çok esnek sünger merkezi ve elyaf dolgulu arka minderler (ayrık) (1/5)',
  ...
  technicalData: '../techdata/MPS-F048.pdf',
};

globals.productManager.addProduct(new FurnitureProduct(mps_f048_data));
