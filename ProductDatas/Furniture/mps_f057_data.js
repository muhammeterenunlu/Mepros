mps_f057_data = {
  ...
  colorsImagesDictionary: {
    '#e5e5e5': [
      '../furniture-images/MPS-F057v1.jpeg',
      '../furniture-images/MPS-F057v2.jpeg',
      '../furniture-images/MPS-F057v3.jpeg',
    ],
  },
  tags: [
    'Removable wooden legs via screwer',
    'Soft plastic glides avoiding the floor damage attached under the legs of all kind.',
  ],
  tags_tr: [
    'Tornavida ile çıkarılabilir ahşap ayaklar',
...
globals.productManager.addProduct(new FurnitureProduct(mps_f057_data));
