mps_f054_data = {
  ...
  colorsImagesDictionary: {
    '#8c6239': [
      '../furniture-images/MPS-F054v1-1.jpeg',
      '../furniture-images/MPS-F054v2-1.jpeg',
      '../furniture-images/MPS-F054v3-1.jpeg',
    ],
    '#00a859': [
      '../furniture-images/MPS-F054v1-2.jpeg',
      '../furniture-images/MPS-F054v2-2.jpeg',
      '../furniture-images/MPS-F054v3-2.jpeg',
    ],
  },
  tags: [
    'Soft plastic glides avoiding the floor damage attached under the legs',
    'One frame construction with fixed seating',
  ],
  tags_tr: [
    'Yumuşak plastik kayar, bacakların altına takılı zemin hasarını önler',
    'Sabit oturmalı tek çerçeve konstrüksiyon',
  ],
  materials: [
    'Plywood framework',
  ...
  materials_tr: [
    ...
    'Doğal kalın kayın ağacından ayaklar ve taban',
...
globals.productManager.addProduct(new FurnitureProduct(mps_f054_data));
