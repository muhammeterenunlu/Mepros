mps_f028_data = {
  ...
  colorsImagesDictionary: {
    '#C7C2B9': [
      '../furniture-images/MPS-F028v1.jpeg',
      '../furniture-images/MPS-F028v2.jpeg',
      '../furniture-images/MPS-F028v3.jpeg',
    ],
  },
  tags: [
  ...
  tags_tr: [
    'Nodus, özgün ve modern tasarımıyla iddialı insanlar içindir. Nodusa oturduğunuzda, rahatlığın ve şıklığın aynı kanepede bir araya geldiğini fark ediyorsunuz.',
  ],
  materials: [
    'Plywood framework',
  ...
  materials_tr: [
    'Kontrplak iskelet',
    'Koltuk altında Nosag Yayları',
    'Çam, Kayın veya Meşe Kollar.',
...
globals.productManager.addProduct(new FurnitureProduct(mps_f028_data));
