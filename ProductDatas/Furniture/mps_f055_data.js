mps_f055_data = {
  ...
  tags: [
    'Additional two arm pillows for 3 seater sofa and sectional sofa',
  ...
  tags_tr: [
    '3lü kanepe ve seksiyonel kanepe için ilave iki kol yastığı',
  ...
  materials_tr: [
    ...
    'Doğal kalın kayın ağacından ayaklar',
  ...
  technicalData: '../techdata/MPS-F055.pdf',
};

globals.productManager.addProduct(new FurnitureProduct(mps_f055_data));
