mps_f060_data = {
  ...
  colorsImagesDictionary: {
    '#ffffff': [
      '../furniture-images/MPS-F060v1-1.jpeg',
      '../furniture-images/MPS-F060v2-1.jpeg',
      '../furniture-images/MPS-F060v3-1.jpeg',
    ],
    '#909194': [
      '../furniture-images/MPS-F060v1-2.jpeg',
      '../furniture-images/MPS-F060v2-2.jpeg',
      '../furniture-images/MPS-F060v3-2.jpeg',
    ],
    '#202f5c': [
      '../furniture-images/MPS-F060v1-3.jpeg',
      '../furniture-images/MPS-F060v2-3.jpeg',
      '../furniture-images/MPS-F060v3-3.jpeg',
    ],
  },
  tags: [
    'Additional two arm pillows for 3 seater sofa, 2 seater sofa, and sectional sofa',
    'Removable legs via screwer',
  ...
  tags_tr: [
    '3lü kanepe, 2li kanepe ve seksiyonel kanepe için ilave iki kol yastığı',
    'Tornavida ile çıkarılabilir bacaklar',
    'Yumuşak plastik kayar ayakların altına takılan zemin hasarını önler',
    'Hareketli oturma ve sırt minderleri',
    'Çıkarılabilir koltuk ve sırt minder kılıfları',
    'Sırt yastıkları, dolgu malzemesine bağlı olarak bir dizi bölmeye sahiptir',
  ],
  materials: [
    'Plywood framework',
  ...
  technicalData: '../techdata/MPS-F060.pdf',
};

globals.productManager.addProduct(new FurnitureProduct(mps_f060_data));
